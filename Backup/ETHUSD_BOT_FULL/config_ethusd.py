...
MAX_SL_USD = 20.0  # Đơn vị: USD (giảm từ 10 xuống 8 để giữ risk $5-10)
...
ATR_MAX_SL_USD = 20.0  # SL tối đa: $10 (cho mode ATR_BOUNDED)
...
# Với giá ETH ~$3000, spread 1000 pips = $10 USD là hợp lý
MAX_SPREAD = 1000  # Đơn vị: pips (giảm từ 1500 xuống 1000 để tăng chất lượng entry)

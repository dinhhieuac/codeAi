...
LOG_FILE = "BTCUSD_BOT_FULL/logs/auto_trader_v3.log"      # File log text (ghi mọi hoạt động, phân tích, lỗi)
                                           # Xem bằng: tail -f logs/auto_trader_v3.log

CSV_LOG_FILE = "BTCUSD_BOT_FULL/logs/trades_v3.csv"        # File log CSV (chỉ ghi lệnh đã mở/đóng)

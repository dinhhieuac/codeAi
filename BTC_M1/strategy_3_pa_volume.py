...
def strategy_3_logic(config, error_count=0):
    ...
    max_spread = 30000  # $300 max for BTC SCALPING
    ...
    # Allow up to 50000 points ($500)
    if dist_to_sma <= 50000 * point: 
        is_near_sma = True
    ...
    if signal:
        ...
        if sl_mode == 'atr':
            ...
            sl = last['low'] - (2000 * point) if signal == "BUY" else last['high'] + (2000 * point)

...
def main():
    ...
    scripts = [
        os.path.join(base_dir, "./exness/md5/XAU_M1/dashboard.py"),
        os.path.join(base_dir, "./exness/md5/ETH_M1/dashboard.py"),
        os.path.join(base_dir, "./exness/md5/BTC_M1/dashboard.py"),
    ]

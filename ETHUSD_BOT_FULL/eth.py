"""
Gold Auto Trader - Hệ thống giao dịch tự động cho vàng (ETHUSD)
...
try:
    import ETHUSD_BOT_FULL.configeth as configeth
    from ETHUSD_BOT_FULL.configeth import *
except ImportError:
...
class GoldAutoTrader:
    ...
    def __init__(self, login: int, password: str, server: str, symbol: str = "ETHUSD"):
        ...
        self.symbol = symbol            # Symbol giao dịch (ETHUSD, XAUUSD, ...)
        ...
        try:
            ...
            import ETHUSD_BOT_FULL.configeth as config

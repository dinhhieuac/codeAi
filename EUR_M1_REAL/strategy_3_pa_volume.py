...
def strategy_3_logic(config, error_count=0):
    ...
    max_spread = 30  # 3 pips max for EURUSD
    ...
    # EURUSD M1 typically has ATR 5-30 pips, so adjust range accordingly
    atr_min = 3   # Minimum ATR (pips) - Adjusted for EURUSD
    atr_max = 30  # Maximum ATR (pips) - Adjusted for EURUSD
    ...
    # Allow up to 5.0 pips distance (50 points) - Adjusted for EURUSD volatility
    max_sma_distance = 50 * point  # 5 pips for EURUSD

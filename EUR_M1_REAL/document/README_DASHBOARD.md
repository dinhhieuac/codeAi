...
Mở file `EUR_M1/strategy_configs.json` và thêm entry mới:
...
Nếu muốn kiểm soát thứ tự hiển thị trong dashboard, mở file `EUR_M1/display_order.json` và thêm strategy name vào list:

...
def check_liquidity_sweep_buy(df_m1, atr_val, symbol="EURUSD", buffer_pips=1, wick_multiplier=1.2):
    """
    ...
    # Buffer: default 1 pip cho EURUSD
    symbol_info = mt5.symbol_info(symbol)
    point = symbol_info.point if symbol_info else 0.0001
    buffer = buffer_pips * point * 10  # 1 pip = 0.0001 cho EURUSD
...
def check_liquidity_sweep_sell(df_m1, atr_val, symbol="EURUSD", buffer_pips=1, wick_multiplier=1.2):
    """

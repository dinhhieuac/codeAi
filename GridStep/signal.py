...
def place_pair_from_relay(payload: Dict[str, Any], volume: float) -> Tuple[bool, str]:
    ...
    Trả (True, "") nếu cả hai TRADE_RETCODE_DONE.
    """
    ...
    try:
        ...
        return False, "grid_preview thiếu buy_price/sell_price"
    ...
    if r1 is None or r2 is None:
        return False, f"order_send None (buy={r1 is None}, sell={r2 is None})"
    ...
    return False, f"BUY {getattr(r1, 'retcode', '?')} SELL {getattr(r2, 'retcode', '?')}"

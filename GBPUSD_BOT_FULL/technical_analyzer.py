...
class TechnicalAnalyzer:
    ...
    def analyze(self, df):
        ...
        # Chuyển đổi ATR từ giá trị giá sang pips (1 pip GBPUSD = 0.0001)
        atr_value = current['atr'] / 0.0001  # ATR tính bằng pips cho GBPUSD
        
        # Kiểm tra ATR filter: Tránh vào lệnh khi volatility quá cao
        max_atr = MAX_ATR if 'MAX_ATR' in globals() else 200

...
def get_pip_value_per_lot(symbol, symbol_info=None):
    ...
    if symbol_info:
        ...
        elif 'EURUSDc' in symbol_upper or 'GBPUSD' in symbol_upper:
            return 10.0
        else:
            return 10.0
...
def m1_scalp_logic(config, error_count=0):
    ...
    try:
        ...
        if result.retcode == mt5.TRADE_RETCODE_DONE:
            ...
            db.log_order(result.order, "M1_Scalp_EURUSD", symbol, signal_type, volume, actual_entry, sl, tp, reason, account_id=config.get('account'))

"""
ETH Auto Trader - Hệ thống giao dịch tự động cho Ethereum (ETHUSD)
...
try:
    import configeth
    from configeth import *
except ImportError:
    print("⚠️  File configeth.py không tìm thấy! Sử dụng giá trị mặc định.")
    # Fallback values
    MT5_LOGIN = 272736909
...
class GoldAutoTrader:
    """
    Hệ thống giao dịch tự động cho ETH
    ...
    def __init__(self, login: int, password: str, server: str, symbol: str = "ETHUSD"):
        """
        ...
        Args:
            ...
            symbol (str): Symbol để giao dịch (mặc định "ETHUSD")
        """
        ...
        self.symbol = symbol            # Symbol giao dịch (ETHUSD, BTCUSD, XAUUSD, ...)
        ...
        try:
            # Thử import hàm từ configeth.py để convert timeframe
            import configeth as config
        ...
        # Cấu hình giao dịch - Risk Management (load từ configeth.py)

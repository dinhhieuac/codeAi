...
# ⚠️ LƯU Ý: BTC trên MT5 thường có lot size tối thiểu là 0.01
MIN_LOT_SIZE = 0.01   # Lot size tối thiểu cho BTCUSD
MAX_LOT_SIZE = 0.5    # Lot size tối đa cho phép mỗi lệnh (giảm để an toàn với BTC)
...
# Với BTCUSD (Bitcoin), biến động lớn nên cần SL tối thiểu 500 pips để tránh bị "quét" bởi biến động ngẫu nhiên
MIN_SL_PIPS = 500  # Tăng lên 500 pips để đủ xa, tránh bị quét bởi noise
...
MAX_SL_USD = 10.0  # Đơn vị: USD (tăng lên 10 để phù hợp với biến động BTC)
...
# ⚠️ Tăng từ 500 lên 1000 pips cho BTC
TRAIL_START_PIPS = 1000  # Đơn vị: pips

# Khoảng cách giữa giá hiện tại và SL khi trailing
# ⚠️ Tăng từ 400 lên 800 pips cho BTC
TRAIL_DISTANCE_PIPS = 800  # Đơn vị: pips

# Nếu lợi nhuận > TRAIL_HARD_LOCK_PIPS thì chốt cứng (đảm bảo không mất lời)
# ⚠️ Tăng từ 800 lên 1600 pips cho BTC
TRAIL_HARD_LOCK_PIPS = 1600  # Đơn vị: pips
...
MAX_ATR = 5000  # Đơn vị: pips (≈ $5000 với 1 lot, tránh volatility cực đại)
...
# ⚠️ Giảm từ 1500 xuống 1000 pips để tránh vào lệnh khi spread quá cao (chi phí cao)
# Với giá BTC ~$90000, spread 3000 pips = $30 USD là hợp lý
MAX_SPREAD = 3000  # Đơn vị: pips (tăng lên 3000 cho BTC)
...
account_json_path = project_root / "BTC_Gemini/md5_accout.json"  # Lưu ý: file có tên "accout" (không phải "account")
